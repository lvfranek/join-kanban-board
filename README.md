...
- Create, edit, and organize tasks on a Kanban-style board
- Drag and drop tasks between status columns
- Assign users and categories to keep your team aligned
- Data persistence and authentication powered by Supabase
